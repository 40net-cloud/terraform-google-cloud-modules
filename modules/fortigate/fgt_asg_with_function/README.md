...
| [google_compute_target_pool.target_pool](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/compute_target_pool) | resource |
...
| <a name="input_network_interfaces"></a> [network\_interfaces](#input\_network\_interfaces) | Network Interfaces | <pre>list(object({<br>    subnet_name   = string<br>    has_public_ip = optional(bool, false)<br>  }))</pre> | `[]` | no |
| <a name="input_network_tags"></a> [network\_tags](#input\_network\_tags) | VM network tags | `list(string)` | `[]` | no |
